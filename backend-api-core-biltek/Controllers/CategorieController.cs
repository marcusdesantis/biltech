...
namespace backend_api_core.Controllers
{
    ...
    {
        private readonly ICategorie _reparto;

        public CategorieController(ICategorie reparto)
        {
        ...
        public async Task<ActionResult<IEnumerable<RespuestaCore>>> Get(string value, string parameter, int currentPageNumber, int amountShow)
        {
            ...
            IEnumerable<CategorieList> _arrayLista = new CategorieList[] { };
        ...
        // POST: api/Modello
        [HttpPost]
        public async Task<ActionResult<object>> Post([FromBody] Categorie data)
        {
            RespuestaCore respuesta = new RespuestaCore();
        ...
        [HttpPut]
        public async Task<ActionResult<object>> Put([FromBody] Categorie data)
        {
            RespuestaCore respuesta = new RespuestaCore();
            RespuestaDB respuestaBD = new RespuestaDB();
