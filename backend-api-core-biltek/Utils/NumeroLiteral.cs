...
namespace backend_api_core.Utils
{
    public class NumeroLiteral
    {
        ...
        public NumeroLiteral(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return NumeroLiteral.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }
