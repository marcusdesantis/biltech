...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-03-2022 a las 18:33:16
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_abm_prodotto` (IN `action` INT, IN `id` INT, IN `Nome` VARCHAR(100), IN `Id_UnitaMisura` INT, IN `Id_TipologiaProdotto` INT, IN `MinimoScortaMagazzino` DECIMAL(10,2), IN `Id_Reparto` INT)  BEGIN
	declare rowAffected int;
	declare lastid int;
    ...
    case action
		when 1 then
			begin
				insert into 
					prodotto 
						(Nome,Id_UnitaMisura,Id_TipologiaProdotto,Id_Reparto,MinimoScortaMagazzino, DataCreazione,Active)
					values
						(Nome,Id_UnitaMisura,Id_TipologiaProdotto,Id_Reparto,MinimoScortaMagazzino ,now(),1);
				select ROW_COUNT() into rowAffected;	
				SELECT LAST_INSERT_ID() into lastid;
...
(4, 'APSOXI', 'AAAAA', 4, b'1', '2022-03-15 19:14:07', '2022-03-15 19:25:03', NULL),
(6, 'PX3202', 'string', 4, b'1', '2022-03-15 19:26:14', NULL, '2022-03-15 19:28:24'),
(7, 'AYTTX4', 'string', 4, b'1', '2022-03-15 19:27:44', NULL, NULL),
(8, 'YTHBVG', 'prueba', 4, b'1', '2022-03-22 08:14:48', NULL, NULL);
...
(4, 6, 2, b'1', '2022-03-25 08:41:26', NULL, NULL);
...
INSERT INTO `misurazione` (`Id`, `Id_Bilancia`, `Id_Prodotto`, `Peso`, `Id_FormulaProdotto`, `Active`, `DataCreazione`, `DataEliminazione`, `DataUltimaModifica`) VALUES
(31, 4, 6, '182.4000', 4, b'1', '2022-03-25 09:58:45', NULL, NULL),
(32, 4, 6, '182.4000', 4, b'1', '2022-03-25 12:29:12', NULL, NULL);
...
INSERT INTO `prodotto` (`Id`, `Nome`, `Id_UnitaMisura`, `Id_TipologiaProdotto`, `Id_Reparto`, `MinimoScortaMagazzino`, `Active`, `DataCreazione`, `DataUltimaModifica`, `DataEliminazione`) VALUES
(6, 'prodotto1', 2, 1, 1, '15.00', b'1', '2022-03-25 08:39:28', NULL, NULL),
(7, 'string2', 2, 1, 1, '80.00', b'0', '2022-03-25 09:46:29', '2022-03-25 09:47:31', '2022-03-25 09:48:24');
